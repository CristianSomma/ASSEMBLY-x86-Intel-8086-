    ...
    start:
        ...
        MOV SI, 0000h   ; definisco SI, ovvero l'offset a zero per scorrere nel vettore dei due numeri
 compare_loop:   ; Label che segna l'inizio del ciclo for
        ...
        MOV BL, num2[SI]    ; salva in bl il valore all'indirizzo DI di num2
 ...
 cx_equ: ; Label che indica il blocco di codice dell'if true
        ...
        MOV BH, num2[SI]    ; stessa cosa viene fatta per num2 in bh
